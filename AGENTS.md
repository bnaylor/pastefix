...
Sources/PastefixCore/
  ...
  Upload/
    ZiplineUpload.swift               # ZiplineUpload request value, ZiplineExpiry, SecretDisposition, UploadPayload.text (the one place that decides which bytes leave), ZiplineUploadError
    ZiplineV4Headers.swift            # ZiplineV4Headers.headers(for:) — the only place a v4 header spelling appears
    ZiplineClient.swift               # ZiplineUploading protocol + URLSessionZiplineClient: multipart body, endpoint normalisation, response/error mapping
